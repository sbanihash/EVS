#PBS -N jevs_global_det_cfs_atmos_grid2obs_stats_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export SENDMAIL=NO
export KEEPDATA=YES
export job=${PBS_JOBNAME:-jevs_global_det_cfs_atmos_grid2obs_stats}
...
#          atmospheric grid-to-observations component for CFS
######################################################################
