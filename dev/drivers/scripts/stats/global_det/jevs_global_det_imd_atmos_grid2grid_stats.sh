#PBS -N jevs_global_det_imd_atmos_grid2grid_stats_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export SENDMAIL=NO
export KEEPDATA=YES
export job=${PBS_JOBNAME:-jevs_global_det_imd_atmos_grid2grid_stats}
...
#          atmospheric grid-to-grid component for IMD
######################################################################
